...
public class TintFieldHook {
    ...
    public static void installCustomTintSlot(Object table) {
        ...
        try {
            ...
            Log.i(TAG, "✓ Context retrieved");

            // ========================================
            // Step 1: Create the field instance
            // ========================================
            ...
            // ========================================
            Method setHighFidelity = labelColorInputClass.getMethod("setHighFidelity", boolean.class);
            setHighFidelity.invoke(fieldInstance, true);
            ...
            // ========================================
            // Step 5: Add separator (optional but matches pattern)
            // ========================================
            // You might want to add a separator here like the other sections
            // This would require getting the TextureAtlas and creating an Image
            // For now, we'll skip this for simplicity

            // ========================================
            // Step 6: Set up field listener
            // ========================================
    ...
    private static Object createFieldListener(
        ...
        return Proxy.newProxyInstance(
                ...
                new InvocationHandler() {
                    private Method redrawModuleMethod = null;
                    private Field animationBasedModuleRefField = null;
                    private Method setAmountMethod = null;
                    private Method setColorMethod = null;

                    {
                        try {
                            ...
                            Log.i(TAG, "✓ Listener methods initialized");
                        } catch (Exception e) {
                            Log.e(TAG, "✗ Error initializing listener methods", e);
                        }
                    }
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        try {
                            if ("onTextFieldTouchEvent".equals(methodName)) {
                                ...
                                Log.d(TAG, "Listener: onTextFieldChange value=" + value);
                                ...
                                Log.d(TAG, "Listener: onColorChange");
    ...
    private static void showToast(Object animationScreen, String message) {
        try {
            if (animationScreen instanceof Context) {
                Context ctx = (Context) animationScreen;
